// import shoes from '../../public/Png_data/shoe.png';
import bags from '../../public/Png_data/bags-img.png';

const Home = () => {
  return (
    <div className="w-full bg-blue-100 lg:flex h-auto">
      <div className="left w-full lg:w-1/2 h-full  pt-35 px-3 lg:px-5 flex flex-col items-center justify-self-start gap-y-3 lg:gap-y-5">
        <h2 className="text-4xl font-[500]  lg:text-6xl lg:font-[400] leading-tight text-blue-500">
          Big Sale 50% Off
        </h2>
      ...
      <div className="right w-full lg:w-1/2 h-full pt-25 flex justify-center items-start px-3">
