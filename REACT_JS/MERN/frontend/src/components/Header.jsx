    ...
    <nav className="relative bg-white shadow-md px-4 sm:px-6 py-4">
      <div className="flex items-center justify-between">
        ...
        <ul className="hidden md:flex items-center gap-8 text-gray-700 font-medium">
          <NavLink to="/" className="hover:text-blue-600 cursor-pointer transition-colors">Home</NavLink>
          <NavLink to="/products" className="hover:text-blue-600 cursor-pointer transition-colors">Products</NavLink>
          <NavLink to="about" className="hover:text-blue-600 cursor-pointer transition-colors">About</NavLink>
        </ul>
